...
func enrichAutoCliOpts(autoCliOpts autocli.AppOptions, clientCtx client.Context) (autocli.AppOptions, error) {
	...
	// Reference: https://github.com/cosmos/interchain-security/blob/v7.0.1/cmd/interchain-security-sd/cmd/root.go#L137
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig appencoding.EncodingConfig) {
	...
	server.AddCommands(rootCmd, sovereignApp.DefaultNodeHome, newApp, appExport, func(*cobra.Command) {})
